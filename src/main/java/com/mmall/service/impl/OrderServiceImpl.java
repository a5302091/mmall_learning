...
public class OrderServiceImpl implements IOrderService {
    ...
    //private static final   = Factory.get(OrderServiceImpl.class);
    ...
    private ServerResponse<List<OrderItem>> getCartOrderItem(Integer userId, List<Cart> cartList) {
        ...
        for (Cart cartItem : cartList) {
            ...
            if (Const.ProductStatusEnum.ON_SALE.getCode() != product.getStatus()) {
                return ServerResponse.createByErrorMessage("该产品" + product.getName() + "已经下架");
            }
            //判断该商品库存是否不足
            if (cartItem.getQuantity() > product.getStock()) {
                return ServerResponse.createByErrorMessage("该产品" + product.getName() + "库存不足" + product.getStock());
            }
    ...
    public ServerResponse cancel(Integer userId, Long orderNo) {
        ...
        if (order.getStatus() != Const.OrderStatusEnum.NO_PAY.getCode()) {
            return ServerResponse.createByErrorMessage("订单已付款,需要联系客服取消");
        }
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path) {
        ...
        String subject = new StringBuilder().append("hql扫码支付,订单号:").append(outTradeNo).toString();
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                .setNotifyUrl(PropertiesUtil.getProperty("ali.callback.url"))//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
    ...
    public ServerResponse aliCallback(Map<String, String> params) {
        ...
        if (order == null) {
            return ServerResponse.createByErrorMessage("订单不属于该业务,回调忽略");
        }
